...
def create_question(question_text, days):
    ...
    return Question.objects.create(questions_text=question_text, publication_date=time)
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_no_questions(self):
        ...
        """
        response = self.client.get(reverse('trees:index'))
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns false for for questions whose
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        url = reverse('trees:detail', args=(future_question.id,))
    ...
    def test_past_question(self):
        ...
        url = reverse('trees:detail', args=(past_question.id,))
        response = self.client.get(url)
