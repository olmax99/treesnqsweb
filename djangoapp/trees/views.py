...
def index(request):
    latest_questions_list = Question.objects.order_by('-publication_date')[:5]
...
def detail(request, question_id):
    ...
    return render(request, 'trees/detail.html', {'question': question})


def results(request, question_id):
    question = get_object_or_404(Question, pk=question_id)
    return render(request, 'trees/results.html', {'question': question})
